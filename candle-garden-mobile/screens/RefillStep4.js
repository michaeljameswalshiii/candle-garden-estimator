    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.quantityContainer}>
          ...
          <TouchableOpacity style={styles.quantityButton} onPress={increaseQuantity} disabled={quantity >= 10}>
            <Text style={styles.quantityButtonText}>+</Text>
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.hintText}>Packed weight includes vessels, box, and packing. UPS bills the greater of scale and dim weight.</Text>
      ...
      <View style={styles.totalSection}>
        ...
        {cost.packed_weight ? (
          <>
            ...
            <Text style={styles.weightDetail}>{cost.packed_weight.breakdownOutbound}</Text>
            <Text style={styles.weightLine}>Empties: {cost.packed_weight.emptiesInboundLabel}</Text>
          </>
        ) : null}
...
const styles = StyleSheet.create({
  container: { flexGrow: 1, backgroundColor: colors.white, padding: spacing.md + 4 },
  title: { fontFamily: fonts.heading, fontSize: 26, fontWeight: '400', marginBottom: 16, color: colors.primary, textAlign: 'center' },
  policyBox: { backgroundColor: colors.lightAccent, padding: 14, borderRadius: radii.md, marginBottom: 15, borderWidth: 1, borderColor: colors.border },
  policyTitle: { fontFamily: fonts.heading, fontSize: 16, color: colors.primary, marginBottom: 6 },
  policyText: { fontFamily: fonts.body, fontSize: 13, color: colors.textSecondary, lineHeight: 19 },
  section: { backgroundColor: colors.surface, padding: 15, borderRadius: radii.md, marginBottom: 15, borderWidth: 1, borderColor: colors.border },
  sectionTitle: { fontFamily: fonts.heading, fontSize: 18, fontWeight: '400', marginBottom: 10, color: colors.darkAccent },
  infoText: { fontFamily: fonts.body, fontSize: 14, marginBottom: 5, color: colors.textMuted },
  totalText: { fontFamily: fonts.body, fontSize: 16, fontWeight: 'bold', marginTop: 10, color: colors.primary },
  quantityContainer: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginVertical: 10 },
  quantityButton: { width: 50, height: 50, backgroundColor: colors.primary, borderRadius: 25, justifyContent: 'center', alignItems: 'center' },
  quantityButtonText: { fontSize: 24, color: colors.white, fontWeight: 'bold' },
  quantityText: { fontFamily: fonts.body, fontSize: 32, fontWeight: 'bold', marginHorizontal: 30, color: colors.text },
  hintText: { fontFamily: fonts.body, fontSize: 12, color: colors.textFaint, textAlign: 'center', marginBottom: 8, lineHeight: 17 },
  zipInput: { fontFamily: fonts.body, fontSize: 20, letterSpacing: 2, textAlign: 'center', backgroundColor: colors.white, borderWidth: 1, borderColor: colors.borderStrong, borderRadius: radii.sm, paddingVertical: 10, color: colors.text, marginTop: 4 },
  boxOption: { flexDirection: 'row', alignItems: 'center', padding: 15, backgroundColor: colors.white, borderRadius: radii.sm, marginBottom: 10, borderWidth: 2, borderColor: colors.borderStrong },
  boxOptionSelected: { borderColor: colors.primary, backgroundColor: colors.primarySoft },
  boxOptionRecommended: { borderColor: colors.warning },
  boxInfo: { flex: 1, paddingRight: 8 },
  boxName: { fontFamily: fonts.body, fontSize: 15, fontWeight: 'bold', color: colors.text },
  boxDetails: { fontFamily: fonts.body, fontSize: 11, color: colors.textMuted, marginTop: 2 },
  boxPrice: { fontFamily: fonts.body, fontSize: 16, fontWeight: 'bold', color: colors.primary },
  recommendedBadge: { position: 'absolute', top: 5, right: 5, fontSize: 10, color: colors.warning, fontWeight: 'bold' },
  totalSection: { backgroundColor: colors.lightAccent, padding: 20, borderRadius: radii.md, alignItems: 'center', marginVertical: 15, borderWidth: 1, borderColor: colors.border },
  totalLabel: { fontFamily: fonts.body, fontSize: 18, color: colors.textMuted },
  totalAmount: { fontFamily: fonts.heading, fontSize: 32, fontWeight: '400', color: colors.primary, marginVertical: 5 },
  totalBreakdown: { fontFamily: fonts.body, fontSize: 12, color: colors.textMuted },
  weightLine: { fontFamily: fonts.body, fontSize: 12, color: colors.textSecondary, marginTop: 8, textAlign: 'center' },
  weightDetail: { fontFamily: fonts.body, fontSize: 11, color: colors.textMuted, marginTop: 2, textAlign: 'center' },
  totalNote: { fontFamily: fonts.body, fontSize: 11, color: colors.textFaint, marginTop: 8, textAlign: 'center' },
  buttonContainer: { gap: 12, marginTop: 20, marginBottom: 24 },
